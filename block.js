 ...
 */
registerBlockType( 'pandp-blocks/accordion', {
  ...
  attributes: {
	...
	edit: props => {
		...
		const { attributes: { heading, subHead, accordionContent }, className, setAttributes } = props;
    ...
    const { attributes: { heading, subHead, accordionContent }, className } = props;
